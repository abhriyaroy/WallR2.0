...
import zebrostudio.wallr100.domain.interactor.AutomaticWallpaperChangerInteractor.Companion.logToFile
...
class AutomaticWallpaperChangerServiceImpl : Service(),
  ...
  override fun onCreate() {
    logToFile("Wallpaper Changer Service created")
    AndroidInjection.inject(this)
    super.onCreate()
  }

  override fun onStartCommand(intent: Intent, flags: Int, startId: Int): Int {
    logToFile("Wallpaper Changer Service started")
    println("Wallpaper Changer Service started")
    createNotification()
  ...
  override fun onDestroy() {
    logToFile("Wallpaper Changer Service destroyed")
    println("Wallpaper Changer Service destroyed")
  ...
  override fun onBind(intent: Intent): IBinder? {
    logToFile("Wallpaper Changer SubscribedService bind")
    println("Wallpaper Changer SubscribedService bind")
