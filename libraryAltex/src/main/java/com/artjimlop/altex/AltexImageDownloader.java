...
public class AltexImageDownloader {
  ...
  public static void writeToDisk(Context context, @NonNull String imageUrl, @NonNull String downloadSubfolder) {
    ...
    String downloadSubpath =fileName;
  ...
  @NonNull private static Uri getDownloadDestination(String downloadSubpath) {
    File directory = new File(Environment.getExternalStorageDirectory()+ File.separator+"WallR");
    long number = (long) Math.floor(Math.random() * 9_000_000_000L) + 1_000_000_000L;
    String fileName=String.valueOf(number);
    File destinationFile = new File(directory+File.separator+"Downloaded Wallpapers", fileName+".jpg");
