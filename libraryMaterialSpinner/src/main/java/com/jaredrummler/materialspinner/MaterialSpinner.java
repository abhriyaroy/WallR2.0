...
public class MaterialSpinner extends TextView {
  ...
  private void init(Context context, AttributeSet attrs) {
    ...
    int defaultPopupPaddingLeft, defaultPopupPaddingTop, defaultPopupPaddingRight,
        defaultPopupPaddingBottom;

    Resources resources = getResources();
    defaultPaddingLeft = defaultPaddingRight =
        defaultPaddingBottom =
            defaultPaddingTop = resources.getDimensionPixelSize(R.dimen.ms__padding_top);
    if (rtl) {
    ...
    defaultPopupPaddingTop =
        defaultPopupPaddingBottom = resources.getDimensionPixelSize(R.dimen.ms__popup_padding_top);
    ...
    try {
      ...
      paddingTop =
          ta.getDimensionPixelSize(R.styleable.MaterialSpinner_ms_padding_top, defaultPaddingTop);
      paddingLeft =
          ta.getDimensionPixelSize(R.styleable.MaterialSpinner_ms_padding_left, defaultPaddingLeft);
      paddingBottom = ta.getDimensionPixelSize(R.styleable.MaterialSpinner_ms_padding_bottom,
          defaultPaddingBottom);
      paddingRight = ta.getDimensionPixelSize(R.styleable.MaterialSpinner_ms_padding_right,
          defaultPaddingRight);
      popupPaddingTop =
          ta.getDimensionPixelSize(R.styleable.MaterialSpinner_ms_popup_padding_top,
              defaultPopupPaddingTop);
      popupPaddingLeft =
          ta.getDimensionPixelSize(R.styleable.MaterialSpinner_ms_popup_padding_left,
              defaultPopupPaddingLeft);
      popupPaddingBottom =
          ta.getDimensionPixelSize(R.styleable.MaterialSpinner_ms_popup_padding_bottom,
              defaultPopupPaddingBottom);
      popupPaddingRight =
          ta.getDimensionPixelSize(R.styleable.MaterialSpinner_ms_popup_padding_right,
    ...
    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
      ...
      popupWindow.setBackgroundDrawable(
          Utils.getDrawable(context, R.drawable.ms__drop_down_shadow));
    }
    ...
    if (background instanceof StateListDrawable) { // pre-L
      try {
        Method getStateDrawable =
            StateListDrawable.class.getDeclaredMethod("getStateDrawable", int.class);
  ...
  @Override public void setEnabled(boolean enabled) {
    ...
    if (arrowDrawable != null) {
      arrowDrawable.setColorFilter(enabled ? arrowColor : arrowColorDisabled,
  ...
  public <T> void setAdapter(MaterialSpinnerAdapter<T> adapter) {
    ...
    this.adapter.setPopupPadding(popupPaddingLeft, popupPaddingTop, popupPaddingRight,
        popupPaddingBottom);
    setAdapterInternal(adapter);
  }
